...
### Description
First insert the base and mount into the assembly. Fasten mate the base to the origin. Now select fastener in the largest circle of the mount that acts as the whole face and fasten mate it to the face of the base. Flip the mount so it is on top of the base and not inside it. now insert the big bearing and the fork into the assembly. Go into the revolute mate and select the inside edge of the big bearing and the edge of the big circle on the mount. Once that is mated move onto Revolute mating the edge of the fork that is located where the long top cylinder meets the top flat part of the fork. That circular edge is what you will select and revolute mate to the inside circle edge of the big bearing, make sure you flip it if needed. Now insert the wheele and axle assembly into the final assembly. Go into revolute mate and select the inner circle of one of the holes in the fork's 2 tall things sticking out the bottom. Once you have one of those inner circles selected, click the edge where the bearing meets the axle on the wheele. Click to flip it and solve it before you click the green check. Next insert two collars Revolute mate again and select the edge where the axle enters the fork as well as the edge of one of the collars. Repeat that on the other side of the fork. Now we select the parallel mate and select the small circle on top of the collar. Also select the face of the flat edge on the axle inside the collar. You may need to zoom in to select the face of the flat edge on the axle. Do that on both collars. Now go to insert and choose Standard Content because we will be adding in bolts then nuts next. Have your selecties at Bolts and Screws for categories, Socket head screws for class, Hex socket head cap screw for Component, M10 for size, 25 for length and thread length (Once you do 25 for length it should automatically change the thread length) and finally stainless steel for material. Click insert and select the 4 small circles on the top of the base over the mount. (The other 2 holes don't need to hold anything so they don't need bolts) Then we add in Nuts. Change the selecties to Category-Nuts, Class-Hex nuts, Component-Hex thin nut grade A&B, Size-M10,Bearing face-washer face, material-stainless steel, finish-plain. Now click insert and select the 4 bottom edges of the small circles on the mount. (They should have bolts in them by now) Now we will add one more bearing; Keep all the same selecties for nuts except the size, the size will now be M20. Insert it on the circle around where the fork's cylinder extrude meets the base. We will insert the pins now. Have the selcties as follows; category-pins, class-parallel pins, component- parallel iso pin 8734, size-3, length-8, Stainless steel and plain finish. Insert a pin in and then select the small circle on the bearing and insert the pin into it. If done correctly it should be centered and only inside the hole, and not poking through the bottom of the flat face on the axel. Do this on both collars. Your done!
### Evidence
